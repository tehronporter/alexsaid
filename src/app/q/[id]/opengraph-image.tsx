...
export const alt = "Alex Said quote card";
...
export default async function Image({ params }: { params: Promise<{ id: string }> }) {
  ...
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", background: "#6B2CFF", color: "white", padding: "64px 72px", fontFamily: "Arial Narrow, sans-serif" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", fontSize: 22, fontWeight: 700 }}><span>{quote.author.toUpperCase()}</span><span>ALEX SAID · UNOFFICIAL</span></div>
    </div>,
    size
  );
}
