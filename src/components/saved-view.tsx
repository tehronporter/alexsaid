...
export function SavedView({ quotes }: { quotes: readonly Quote[] }) {
  ...
  if (!saved.length) return (
    <Card className="content-card mx-auto max-w-xl items-center p-10 text-center">
      ...
      <p className="max-w-sm text-sm leading-relaxed text-white/50">Tap the bookmark on any quote and it will stay saved on this device—even when you’re offline.</p>
